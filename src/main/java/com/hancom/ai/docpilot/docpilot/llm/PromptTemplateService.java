...
public class PromptTemplateService {
    ...
    private static final Map<String, String> TEMPLATES = Map.ofEntries(
            Map.entry("service_overview", """
                    ...
                    - 마크다운 코드블록을 <pre> 태그로 변환 (예: <pre>코드내용</pre>)
                    - 마크다운 인라인 코드를 <code> 태그로 변환
                    ...
                    금지 사항:
                    - <ac:structured-macro>, <ac:parameter>, <ac:rich-text-body> 등 Confluence 매크로 태그를 절대 사용하지 마세요.
                    - 기본 HTML 태그만 사용하세요: <h1>~<h6>, <p>, <ul>, <ol>, <li>, <table>, <tr>, <th>, <td>, <pre>, <code>, <strong>, <em>, <a>, <br>
            ...
            Map.entry("api_spec", """
                    ...
                    금지: <ac:structured-macro>, <ac:parameter>, <ac:rich-text-body> 등 Confluence 매크로 태그를 사용하지 마세요. 기본 HTML 태그만 사용하세요.
                    반드시 Confluence Storage Format(XML)으로만 응답하세요. 코드블록 마커(예: xml), 설명, 마크다운은 포함하지 마세요.
